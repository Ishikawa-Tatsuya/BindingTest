...
namespace Test
{
    ...
    public class WPFDependencyObjectCollection : IAppVarOwner
    {
        ...
        public int Count { get { return this.Dynamic().Length; } }
        ...
        public AppVar Identify()
        {
            if (Count != 1)
            {
                throw new NotSupportedException(Count.ToString());
            }
    ...
    public static class TreeExtensions
    {
        ...
        public static DependencyObject[] GetVisualTreeCollectionDepthFirst(DependencyObject obj)
        {
        ...
        public static DependencyObject[] GetVisualTreeCollectionAncestor(DependencyObject obj)
        {
            List<DependencyObject> list = new List<DependencyObject>();
            while (obj != null)
            {
        ...
        public static DependencyObject[] GeLogicalTreeCollectionDepthFirst(DependencyObject obj)
        {
            List<DependencyObject> list = new List<DependencyObject>();
            list.Add(obj);
        ...
        public static DependencyObject[] GeLogicalTreeCollectionAncestor(DependencyObject obj)
        {
            List<DependencyObject> list = new List<DependencyObject>();
            while (obj != null)
            {
    ...
    public static class BindingSearchExtensions
    {
        ...
        public static bool IsMatch(DependencyObject obj, string path, object dataItem = null)
        {
            return GetDependencyProperties(obj).
                    Select(e => BindingOperations.GetBindingExpression(obj, e)).
        ...
        {
            return collection.Where(element =>IsMatch(element, path, dataItem)).ToArray();
        }
